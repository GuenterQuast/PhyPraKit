...
# Auto-Korrelation
  ...
  ax3.plot(ac_t, ac_a)
  ax3.plot([0.,ac_t[-1]],[1., 0.],'m--', alpha=0.3) # maximum auto-correlation
...
#  ax4.legend(loc='best', numpoints=1, prop={'size':10})
  ...
  ax4.text(0.05, 0.9,  "mean=(%.5g$\pm$%.2g) ms"%(m_dtp, 
     max(sm_dtp, (be[1]-be[0])/np.sqrt(12) ) ),
